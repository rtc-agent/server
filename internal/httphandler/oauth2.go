...
import (
	...
	"github.com/rtc-agent/server/internal/httputil"
...
type ProviderClient interface {
	...
	ExchangeCode(ctx context.Context, provider string, code string, redirectURI string) (*oauth2provider.ProviderUserInfo, error)
}
...
func (h *OAuth2Handler) findOrCreateUser(ctx context.Context, provider string, userInfo *oauth2provider.ProviderUserInfo) (*dbmodel.OAuth2User, error) {
